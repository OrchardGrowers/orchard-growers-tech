...
export const createScanRecord = ({
  ...
  return {
    ...
    analysis: {
      status: process.env.FRUIT_ANALYSIS_PROVIDER_URL ? "PENDING" : "REVIEW_REQUIRED",
      grade: boundedText(session.gradeKey, 100),
      analysisVersion: "fruit-object-analysis-v1",
      modelProvider: null,
      modelVersion: null,
      analyzedAt: null,
      imagesAnalyzed: 0,
      ...
      surface: null,
      maturity: null,
      russetingPercent: null,
      decayPercent: null,
      defectPercent: null,
      uniformityScore: null,
      imageQuality: null,
      warningCodes: process.env.FRUIT_ANALYSIS_PROVIDER_URL
        ? []
        : ["ANALYSIS_PROVIDER_NOT_CONFIGURED"],
      failureCode: process.env.FRUIT_ANALYSIS_PROVIDER_URL
        ? null
        : "ANALYSIS_PROVIDER_NOT_CONFIGURED",
      aiStatus: process.env.FRUIT_ANALYSIS_PROVIDER_URL ? "PENDING" : "REVIEW_REQUIRED",
      aiVersion: "fruit-object-analysis-v1",
