...
router.get("/sitemap.xml", async (req, res) => {
  try {
    const staticUrls = [
      ...
      { loc: "/blog/fruit-buyers/apple", changefreq: "monthly", priority: "0.7" },
      { loc: "/blog/fruit-growers/apple", changefreq: "monthly", priority: "0.7" },
      { loc: "/blog/fruit-transport", changefreq: "monthly", priority: "0.7" },
