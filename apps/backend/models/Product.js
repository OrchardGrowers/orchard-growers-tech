...
const productSchema = new mongoose.Schema(
  {
      ...
      type: [
        {
          ...
          traysPerPackage: Number,
          piecesPerTray: Number,
          weightPerPackageKg: Number,
          packageCapacityCode: String,
          packageTypeCode: String,
          packageSizeCode: String,
          customPackageTypeSpecification: String,
          customPackageSizeSpecification: String,
          diameterPresetCode: String,
    ...
    packingSummary: {
      type: {
        ...
        totalPieces: Number,
        totalWeightKg: Number,
        averageFruitWeightGrams: Number,
      },
      default: undefined,
    },
    basePrice: Number,
