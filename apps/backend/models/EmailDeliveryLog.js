...
const emailDeliveryLogSchema = new mongoose.Schema(
  {
    ...
    ccRecipients: [{ type: String, trim: true, lowercase: true, maxlength: 320 }],
    bccRecipients: [{ type: String, trim: true, lowercase: true, maxlength: 320 }],
    attachments: [{
      filename: { type: String, trim: true, maxlength: 120 },
      contentType: { type: String, trim: true, maxlength: 120 },
      size: { type: Number, min: 1, max: 2097152 },
      _id: false,
    }],
