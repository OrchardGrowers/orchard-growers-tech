...
const quotationGradeSchema = new mongoose.Schema(
  {
    ...
    growerPlatformServiceFee: { type: Number, default: 0, min: 0 },
    buyerPlatformServiceFee: { type: Number, default: 0, min: 0 },
...
const quotationSchema = new mongoose.Schema(
  {
    ...
    growerCommissionRate: { type: Number, default: 0, min: 0 },
    buyerCommissionRate: { type: Number, default: 0, min: 0 },
    commissionVersion: { type: String, trim: true, default: "" },
    commissionAmount: { type: Number, required: true, min: 0 },
    growerCommissionAmount: { type: Number, default: 0, min: 0 },
    buyerCommissionAmount: { type: Number, default: 0, min: 0 },
    commissionTaxRate: { type: Number, default: 0, min: 0 },
    growerCommissionTaxAmount: { type: Number, default: 0, min: 0 },
    buyerCommissionTaxAmount: { type: Number, default: 0, min: 0 },
    platformServiceFee: { type: Number, default: 0, min: 0 },
