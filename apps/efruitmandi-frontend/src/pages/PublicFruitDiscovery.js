...
function Unavailable() { return <><SEO title="Fruit page unavailable | eFruitMandi" canonical={null} robots="noindex,follow" image={null} /><main className="mx-auto min-h-[60vh] max-w-3xl px-4 py-14 text-center"><h1 className="text-2xl font-bold">Fruit page unavailable</h1><Link to="/fruits" className="mt-6 inline-flex font-bold text-green-800">Browse public fruits</Link></main></>; }
